  ...
  return (
    <ImageBackground
      ...
      <View style={[styles.container, {backgroundColor}]}>
        <View
          style={[styles.tabContent, activeTab !== 'Video' && styles.hidden]}>
          {videoScreen}
        </View>
        <View
          style={[styles.tabContent, activeTab !== 'Story' && styles.hidden]}>
          {storyScreen}
        </View>
        <View
          style={[styles.tabContent, activeTab !== 'Poll' && styles.hidden]}>
          {pollScreen}
        </View>
      </View>
    </ImageBackground>
