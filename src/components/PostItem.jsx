...
//   const latestComment = commentCount > 0 ? item.comments[0] : null; // Get latest comment
...
//         </View>
//         <View style={styles.actionGroup}>
//           <SvgXml xml={chat_icon} width={17} height={16.04} />
//           <Text style={styles.actionText}>{commentCount}</Text>
//         </View>
//         <TouchableOpacity style={styles.shareButton}>
//           <SvgXml xml={share_svg} width={18} height={15.73} />
//         </TouchableOpacity>
//       </View>
...
//     height: 20,
//     borderRadius: 15,
//     marginRight: 10, // Makes it circular
//     overflow: "hidden", // Ensures the SVG is clipped inside the border
//     borderWidth: 1, // Border thickness
//     borderColor: "#D3D3D3", // Border color (black in this case)
//     alignItems: "center",
//     justifyContent: "center",
//   },
//   commentText: {
...
const styles = StyleSheet.create({
  ...
  actionGroup: {flexDirection: 'row', alignItems: 'center', marginRight: 20},
  actionText: {
    marginLeft: 5,
    fontSize: 14,
    fontWeight: '500',
  ...
  commentsSection: {marginTop: 5, paddingLeft: 8},
  comment: {flexDirection: 'row', alignItems: 'center', marginBottom: 5},
  commentAvatar: {width: 20, height: 20, borderRadius: 10, marginRight: 10},
  commentText: {fontSize: 10, fontWeight: '500', color: '#66645E', flex: 1},
  commentUser: {fontWeight: '700', color: '#000'},
  viewAllComments: {
    color: '#66645E',
    fontWeight: '500',
    fontSize: 10,
