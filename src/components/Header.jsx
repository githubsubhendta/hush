      ...
      <View style={styles.centerContainer}>
        {['Hot', 'Global', 'Local'].map(tab => (
          <TouchableOpacity
            ...
            <Text
              style={[styles.menuText, activeTab === tab && styles.activeText]}>
              {tab}
            </Text>
          </TouchableOpacity>
        ))}
...
//                 <TouchableOpacity onPress={() => setIsModernOn(!isModernOn)}>
//                   <SvgXml
//                     xml={isModernOn ? modern_mode_on_svg : modern_mode_off_svg}
//                     width={65}
//                     height={26}
//                   />
//                 </TouchableOpacity>
