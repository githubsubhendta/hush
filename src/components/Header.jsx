...
//       defaultTab="hot"
//       tabs={[
//         {key: 'hot', label: 'Hot', icon: fire_svg},
//         {key: 'global', label: 'Global', icon: global_svg},
//         {key: 'local', label: 'Local', icon: local_svg},
//       ]}
//       onTabPress={tabKey => console.log('Tab changed to:', tabKey)}
//       showButtons={true}
//       customButtons={[
//         {
//           label: 'Get Premium',
...
const Header = ({ onTabPress }) => {
  const [activeTab, setActiveTab] = useState('Hot');
  const [modalVisible, setModalVisible] = useState(false); // explicitly false
